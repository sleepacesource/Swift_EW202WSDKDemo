...
class LightViewController: UIViewController {
    ...
    @IBAction func changeBrightness(_ sender: Any) {
        ...
        SLPLTcpManager.sharedLTCP()?.ew202wLightControlOperation(2, brightness: br, lightMode: 0xff, light: light, deviceInfo: "EW22W20C00045", timeout: 10.0, callback: {(status: SLPDataTransferStatus, data: Any?) in
    ...
    @IBAction func closeLight(_ sender: Any) {
        ...
        SLPLTcpManager.sharedLTCP()?.ew202wLightControlOperation(0, brightness: 0, lightMode: 0xff, light:  SLPLight(), deviceInfo: "EW22W20C00045", timeout: 10.0, callback: {(status: SLPDataTransferStatus, data: Any?) in
